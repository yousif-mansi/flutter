...
import 'modal_create_model.dart';
export 'modal_create_model.dart';

class ModalCreateWidget extends StatefulWidget {
  const ModalCreateWidget({super.key});

  @override
  State<ModalCreateWidget> createState() => _ModalCreateWidgetState();
}

class _ModalCreateWidgetState extends State<ModalCreateWidget>
    with TickerProviderStateMixin {
  late ModalCreateModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ModalCreateModel());
