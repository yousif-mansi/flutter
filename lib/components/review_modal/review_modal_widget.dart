...
import 'review_modal_model.dart';
export 'review_modal_model.dart';

class ReviewModalWidget extends StatefulWidget {
  const ReviewModalWidget({super.key});
...
class _ReviewModalWidgetState extends State<ReviewModalWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ReviewModalModel());
